...
net_out = load_itk('net_out_masks_torch_2/AR-2_rs_mask.mhd')
...
net_out = load_itk('net_out_masks_torch/AR-2_rs_mask.mhd')
print(net_out[0].shape)
...
net_out = load_itk('net_out_masks_torch_2/AR-3_rs_mask.mhd')
print(net_out[0].shape)
...
net_out = load_itk('net_out_masks_torch/AR-3_rs_mask.mhd')
print(net_out[0].shape)
...
net_out = load_itk('net_out_masks_torch_2/AR-9_rs_mask.mhd')
print(net_out[0].shape)
...
net_out = load_itk('net_out_masks_torch_2/AR-1_rs_mask.mhd')
print(net_out[0].shape)
...
net_out = load_itk('net_out_masks_torch/AR-1_rs_mask.mhd')
print(net_out[0].shape)
...
for n in range(0, depth, step):
    ax[n // step, 0].imshow(img_flair_rs[0][:,:, n], cmap='gray')
    ax[n // step, 0].set_title('Original')
    ax[n // step, 1].imshow(seg_rs[0][:,:, n], cmap='gray')
    ax[n // step, 1].set_title('Mask')
    ax[n // step, 2].imshow(net_out[0][n,:,:], cmap='gray')
    ax[n // step, 2].set_title('Network output');
...
net_out = load_itk('net_out_masks_torch_2/AR-17_rs_mask.mhd')
print(net_out[0].shape)
...
net_out = load_itk('net_out_masks_torch/AR-12_rs_mask.mhd')
print(net_out[0].shape)
...
seg_rs = load_itk('AR-7/Segmentation-label.mhd')
seg_rs[0].shape
