...
class VGG(nn.Module):
    def __init__(self, from_pretrained=False):
        ...
        self.features = nn.Sequential(
            nn.Conv3d(1, 64, kernel_size=3, stride=1, paddn,
            nn.BatchNorm3d(64, eps=1e-05, momentum=0.1, affine=True,
                           track_running_stats=True),
            nn.ReLU(inplace=True),
            nn.Conv3d(64, 64, kernel_size=3, stride=1, paddn,
            nn.BatchNorm3d(64, eps=1e-05, momentum=0.1, affine=True,
                           track_running_stats=True),
            nn.ReLU(inplace=True),
            nn.MaxPool3d(kernel_size=2, stride=2,
                         padding=0, dilation=1, ceil_mode=False),
            nn.Conv3d(64, 128, kernel_size=3, stride=1, paddn,
            nn.BatchNorm3d(128, eps=1e-05, momentum=0.1, affine=True,
                           track_running_stats=True),
            nn.ReLU(inplace=True),
            nn.Conv3d(128, 128, kernel_size=3, stride=1, paddn,
            nn.BatchNorm3d(128, eps=1e-05, momentum=0.1, affine=True,
                           track_running_stats=True),
            nn.ReLU(inplace=True),
            nn.MaxPool3d(kernel_size=2, stride=2,
                         padding=0, dilation=1, ceil_mode=False),
            nn.Conv3d(128, 256, kernel_size=3, stride=1, paddn,
            nn.BatchNorm3d(256, eps=1e-05, momentum=0.1, affine=True,
                           track_running_stats=True),
            nn.ReLU(inplace=True),
            nn.Conv3d(256, 256, kernel_size=3, stride=1, paddn,
            nn.BatchNorm3d(256, eps=1e-05, momentum=0.1, affine=True,
                           track_running_stats=True),
            nn.ReLU(inplace=True),
            nn.Conv3d(256, 256, kernel_size=3, stride=1, paddn,
            ...
            nn.MaxPool3d(kernel_size=2, stride=2,
                         padding=0, dilation=1, ceil_mode=False),
            nn.Conv3d(256, 512, kernel_size=3, stride=1, paddn,
            nn.BatchNorm3d(512, eps=1e-05, momentum=0.1, affine=True,
                           track_running_stats=True),
            nn.ReLU(inplace=True),
            nn.Conv3d(512, 512, kernel_size=3, stride=1, paddn,
            nn.BatchNorm3d(512, eps=1e-05, momentum=0.1, affine=True,
                           track_running_stats=True),
            nn.ReLU(inplace=True),
            nn.Conv3d(512, 512, kernel_size=3, stride=1, paddn,
